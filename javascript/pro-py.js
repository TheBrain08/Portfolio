...
const Projects = [{
        ...
        title: "TicTacToe",
        headlines: [
            { headline: "Startscreen / Playfield" },
            { headline: "Scoreboard" },
            { headline: "Select your symbol" },
            { headline: "First move" },
            { headline: "Next move & Auto change" },
            { headline: "Win" },
            { headline: "Scoreboard change" },
            { headline: "COM mode" },
            { headline: '"Features"' }
        ],
        texte: [{
...
function loadPopupContent(project) {
    ...
    if (Projects[whichProject].headlines) {
        ...
        popupContentContainer.append(projectHeadlines, headlineWrapper, stackHTML);
    }
}